...
| 1.1.41 | `INSERT` | 支持 values、insert-select、无 target DO NOTHING、单列主键/唯一列 target 的常量 DO UPDATE、returning 部分；缺少 `OVERRIDING`、ON CONFLICT constraint/index inference 全集、复杂 DO UPDATE/WHERE、RETURNING OLD/NEW | ⚠️ |
