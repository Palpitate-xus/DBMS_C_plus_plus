...
- **Wave 4 DDL 完整化 — SEQUENCE 完整语义（4.33，本次完成）**：
...
- **Wave 4 仍进行中**：`CREATE TABLE AS`、ALTER TABLE 全量子命令、VIEW、TRIGGER、DOMAIN、FUNCTION/PROCEDURE、POLICY、MATERIALIZED VIEW、CREATE TYPE ENUM 等。
