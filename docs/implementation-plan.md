...
- **Wave 4 仍进行中**：ALTER TABLE 全量子命令、VIEW、TRIGGER、FUNCTION/PROCEDURE、POLICY、MATERIALIZED VIEW、CREATE TYPE ENUM、CREATE TABLE 选项（LIKE INCLUDING、OF、PARTITION BY）等。
