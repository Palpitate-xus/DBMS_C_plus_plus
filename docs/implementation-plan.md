...
| 🔄 9.4 实现 logging collector、CSV/JSON logs、`log_line_prefix` | 13.4 | LogManager exists; CSV/JSON formatters deferred |
...
| 子任务 | 涉及的 gap | 备注 |
|--------|-----------|------|
| 🔄 10.1 实现 `CREATE EXTENSION` / `ALTER EXTENSION` / `DROP EXTENSION` | 14.1, 1.2.5 | parser supports; runtime catalog registration deferred |
