...
- 协议扩展查询回归：验证 `ParameterDescription`、文本整数参数 `$1`、statement `Describe`、portal/statement `Close` 的真实 Parse/Bind/Execute 生命周期，以及 `int4` 的 OID/长度/属性号/表 OID RowDescription 元数据。
