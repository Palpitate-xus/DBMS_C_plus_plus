...
dbms_init_build_config() {
    ...
    DBMS_E2E_TESTS=(tests/postgres_protocol_test.py tests/window_e2e_test.py tests/inherit_only_e2e_test.py tests/explain_analyze_e2e_test.py tests/unnest_e2e_test.py)
